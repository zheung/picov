...
// 配置
export const C = new Config(dirConfig, '.db');
...
FX.ensureDirSync(C.path.dirIllustSave);
FX.ensureDirSync(C.path.dirIllustArch);
FX.ensureDirSync(C.path.dirUgoiraNew);
FX.ensureDirSync(C.path.dirUgoiraSaved);